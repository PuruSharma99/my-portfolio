  ...
  return (
    <div className="about">
      ...
      <div className="abt-det">
        Currently working as a Front End Developer at <u>Indus EyeCare Solutions LLP</u>, where I focus on advancing my skills and expanding my expertise.
        </div>
        <div className="abt-det">
          I'm all about making websites look cool and work smoothly. I love
          turning designs into real, clickable things on the internet. With over 1.5 years+ of experience with React.js and JavaScript.
        </div>
        <div className="abt-det">
